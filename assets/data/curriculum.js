/* ============================================================
   ...
   لإضافة درسٍ حقيقيّ: أنشئ ملفَّ الدرس (window.LESSONS['REF'])، ثمّ سجّله في الفهرس
   lesson-manifest.js (REF ← مسار الملفّ وعددُ مراحله) للتحميل حسب الطلب، وأشِر إليه هنا عبر ref.
   الدروس بلا ref (أو غير المفهرسة) تظهر «قريبًا».
   ============================================================ */
window.CURRICULUM = {
  grades:[
    {id:'p3', name:'الثالث الابتدائي', num:'٣', desc:'الصف الثالث من المرحلة الابتدائية', stage:'المرحلة الابتدائية'},
    {id:'p4', name:'الرابع الابتدائي', num:'٤', desc:'الصف الرابع من المرحلة الابتدائية', stage:'المرحلة الابتدائية'},
    {id:'p5', name:'الخامس الابتدائي', num:'٥', desc:'الصف الخامس من المرحلة الابتدائية', stage:'المرحلة الابتدائية'},
    {id:'p6', name:'السادس الابتدائي', num:'٦', desc:'الصف السادس من المرحلة الابتدائية', stage:'المرحلة الابتدائية'},
    {id:'g1', name:'الأول متوسط',  num:'١', desc:'الصف الأول من المرحلة المتوسطة', stage:'المرحلة المتوسطة'},
    {id:'g2', name:'الثاني متوسط', num:'٢', desc:'الصف الثاني من المرحلة المتوسطة', stage:'المرحلة المتوسطة'},
    {id:'g3', name:'الثالث متوسط', num:'٣', desc:'الصف الثالث من المرحلة المتوسطة', stage:'المرحلة المتوسطة'}
  ],
  semesters:[
    {id:'s1', name:'الفصل الدراسي الأول', desc:'الوحدات من بداية العام حتى منتصفه'},
    /* إطلاقٌ مرحليّ: الفصل الثاني مقفلٌ حتى موعد نشره. لفتحه لاحقًا: احذفْ locked:true وارفعْ رقمَ CACHE في sw.js. */
  ...
  content:{
    /* ===== الثالث الابتدائي · الفصل الأول ===== */
    'p3.s1.math':{ eyebrow:'رياضيات · الثالث الابتدائي', units:[
      { t:'القيمة المنزلية', s:'الفصل الأول', lessons:[
        { t:'الأنماط العددية', tag:'جبر', ref:'MATH_P3_U1_PATTERNS' },
        { t:'القيمة المنزلية ضمن الألوف', tag:'أعداد', ref:'MATH_P3_U1_THOUSANDS' },
        { t:'القيمة المنزلية ضمن عشرات الألوف', tag:'أعداد', ref:'MATH_P3_U1_TENTHOUS' },
        { t:'مقارنة الأعداد', tag:'أعداد', ref:'MATH_P3_U1_COMPARE' },
        { t:'ترتيب الأعداد', tag:'أعداد', ref:'MATH_P3_U1_ORDER' },
        { t:'التقريب إلى أقرب عشرة ومئة وألف', tag:'أعداد', ref:'MATH_P3_U1_ROUND' }
      ]},
      { t:'الجمع', s:'الفصل الثاني', lessons:[
        { t:'خصائص الجمع', tag:'جبر', ref:'MATH_P3_U2_PROPS' },
        { t:'تقدير نواتج الجمع', tag:'مهارة', ref:'MATH_P3_U2_ESTIMATE' },
        { t:'جمع الأعداد المكونة من رقمين', tag:'أعداد', ref:'MATH_P3_U2_ADD2' },
        { t:'جمع الأعداد المكونة من ثلاثة أرقام', tag:'أعداد', ref:'MATH_P3_U2_ADD3' }
      ]},
      { t:'الطرح', s:'الفصل الثالث', lessons:[
        { t:'طرح الأعداد المكونة من رقمين', tag:'أعداد', ref:'MATH_P3_U3_SUB2' },
        { t:'تقدير نواتج الطرح', tag:'مهارة', ref:'MATH_P3_U3_ESTIMATE' },
        { t:'طرح الأعداد المكونة من ثلاثة أرقام', tag:'أعداد', ref:'MATH_P3_U3_SUB3' },
        { t:'الطرح مع وجود الأصفار', tag:'أعداد', ref:'MATH_P3_U3_SUBZERO' }
      ]},
      { t:'الضرب (١)', s:'الفصل الرابع', lessons:[
        { t:'معنى الضرب', tag:'أعداد', ref:'MATH_P3_U4_MEANING' },
        { t:'الضرب في ٢ وفي ٥', tag:'أعداد', ref:'MATH_P3_U4_MUL25' },
        { t:'الضرب في ٤', tag:'أعداد', ref:'MATH_P3_U4_MUL4' },
        { t:'الضرب في ١٠', tag:'أعداد', ref:'MATH_P3_U4_MUL10' },
        { t:'الضرب في الصفر وفي الواحد', tag:'أعداد', ref:'MATH_P3_U4_MUL01' }
      ]},
      { t:'الضرب (٢)', s:'الفصل الخامس', lessons:[
        { t:'الضرب في ٣ وفي ٦', tag:'أعداد', ref:'MATH_P3_U5_MUL36' },
        { t:'الضرب في ٧ وفي ٨', tag:'أعداد', ref:'MATH_P3_U5_MUL78' },
        { t:'الضرب في ٩', tag:'أعداد', ref:'MATH_P3_U5_MUL9' },
        { t:'الخاصية التجميعية للضرب', tag:'جبر', ref:'MATH_P3_U5_ASSOC' }
      ]}
    ]},

    'p3.s1.sci':{ eyebrow:'علوم · الثالث الابتدائي', units:[
      { t:'التعرّف على المخلوقات الحيّة', s:'المخلوقات الحيّة · الفصل الأول', lessons:[
        { t:'المخلوقات الحيّة وحاجاتها', tag:'أحياء', ref:'SCI_P3_U1_NEEDS' },
        { t:'النباتات وأجزاؤها', tag:'نبات', ref:'SCI_P3_U1_PLANTS' }
      ]},
      { t:'المخلوقات الحيّة تنمو وتتغيّر', s:'المخلوقات الحيّة · الفصل الثاني', lessons:[
        { t:'دورات حياة النباتات', tag:'نبات', ref:'SCI_P3_U2_PLANTLIFE' },
        { t:'دورات حياة الحيوانات', tag:'أحياء', ref:'SCI_P3_U2_ANIMLIFE' }
      ]},
      { t:'المخلوقات الحيّة في النظام البيئي', s:'النظام البيئي · الفصل الثالث', lessons:[
        { t:'السلاسل والشبكات الغذائيّة', tag:'بيئة', ref:'SCI_P3_U3_FOODCHAIN' },
        { t:'التكيّف', tag:'بيئة', ref:'SCI_P3_U3_ADAPT' }
      ]},
      { t:'التغيّرات في النظام البيئي', s:'النظام البيئي · الفصل الرابع', lessons:[
        { t:'المخلوقات الحيّة تغيّر بيئاتها', tag:'بيئة', ref:'SCI_P3_U4_CHANGEENV' },
        { t:'تغيّرات تؤثّر في المخلوقات الحيّة', tag:'بيئة', ref:'SCI_P3_U4_ENVCHANGE' }
      ]},
      { t:'الأرض تتغيّر', s:'الأرض ومواردها · الفصل الخامس', lessons:[
        { t:'تغيّرات الأرض الفجائيّة', tag:'أرض', ref:'SCI_P3_U5_SUDDEN' },
        { t:'التجوية والتعرية', tag:'أرض', ref:'SCI_P3_U5_WEATHER' }
      ]},
      { t:'موارد الأرض', s:'الأرض ومواردها · الفصل السادس', lessons:[
        { t:'التربة', tag:'أرض', ref:'SCI_P3_U6_SOIL' },
        { t:'الأحافير والوقود الأحفوريّ', tag:'موارد', ref:'SCI_P3_U6_FOSSILS' }
      ]}
    ]},
    ...
    'p4.s1.math':{ eyebrow:'رياضيات · الرابع الابتدائي', units:[
      { t:'القيمة المنزلية', s:'الفصل الأول', lessons:[
        { t:'القيمة المنزلية ضمن مئات الألوف', tag:'أعداد', ref:'MATH_P4_U1_PLACE' },
        { t:'القيمة المنزلية ضمن الملايين', tag:'أعداد', ref:'MATH_P4_U1_MILLIONS' },
        { t:'المقارنة بين الأعداد', tag:'أعداد', ref:'MATH_P4_U1_COMPARE' },
        { t:'ترتيب الأعداد', tag:'أعداد', ref:'MATH_P4_U1_ORDER' },
        { t:'تقريب الأعداد', tag:'أعداد', ref:'MATH_P4_U1_ROUND' }
      ]},
      { t:'الجمع والطرح', s:'الفصل الثاني', lessons:[
        { t:'خصائص الجمع وقواعد الطرح', tag:'جبر', ref:'MATH_P4_U2_ADDPROPS' },
        { t:'تقدير المجموع والفرق', tag:'مهارة', ref:'MATH_P4_U2_ESTIMATE' },
        { t:'جمع الأعداد', tag:'أعداد', ref:'MATH_P4_U2_ADD' },
        { t:'طرح الأعداد', tag:'أعداد', ref:'MATH_P4_U2_SUB' },
        { t:'الطرح مع وجود الأصفار', tag:'أعداد', ref:'MATH_P4_U2_SUBZERO' }
      ]},
      { t:'تنظيم البيانات وعرضها وتفسيرها', s:'الفصل الثالث', lessons:[
        { t:'جمع البيانات وتنظيمها', tag:'بيانات', ref:'MATH_P4_U3_COLLECT' },
        { t:'التمثيل بالأعمدة', tag:'بيانات', ref:'MATH_P4_U3_BARS' },
        { t:'التمثيل بالخطوط', tag:'بيانات', ref:'MATH_P4_U3_LINES' },
        { t:'التمثيل بالقطاعات الدائرية', tag:'بيانات', ref:'MATH_P4_U3_CIRCLES' },
        { t:'الاحتمال', tag:'بيانات', ref:'MATH_P4_U3_PROB' }
      ]},
      { t:'الأنماط والجبر', s:'الفصل الرابع', lessons:[
        { t:'العبارات والجمل العددية', tag:'جبر', ref:'MATH_P4_U4_EXPR' },
        { t:'تمثيل الجمل العددية وكتابتها', tag:'جبر', ref:'MATH_P4_U4_SENTENCES' },
        { t:'اكتشاف قاعدة النمط', tag:'جبر', ref:'MATH_P4_U4_RULE' },
        { t:'جداول الدوال: الجمع والطرح', tag:'جبر', ref:'MATH_P4_U4_FUNCAS' },
        { t:'جداول الدوال: الضرب والقسمة', tag:'جبر', ref:'MATH_P4_U4_FUNCMD' }
      ]},
      { t:'الضرب في عدد من رقم واحد', s:'الفصل الخامس', lessons:[
        { t:'القواسم والمضاعفات', tag:'أعداد', ref:'MATH_P4_U5_FACTORS' },
        { t:'الضرب في مضاعفات العشرة', tag:'أعداد', ref:'MATH_P4_U5_TENS' },
        { t:'تقدير نواتج الضرب', tag:'مهارة', ref:'MATH_P4_U5_ESTIMATE' },
        { t:'ضرب عدد من رقمين في عدد من رقم واحد', tag:'أعداد', ref:'MATH_P4_U5_MUL2' },
        { t:'ضرب عدد من ثلاثة أرقام في عدد من رقم واحد', tag:'أعداد', ref:'MATH_P4_U5_MUL3' }
      ]},
      { t:'الضرب في عدد من رقمين', s:'الفصل السادس', lessons:[
        { t:'الضرب في مضاعفات العشرة', tag:'أعداد', ref:'MATH_P4_U6_TENS' },
        { t:'تقدير نواتج الضرب', tag:'مهارة', ref:'MATH_P4_U6_ESTIMATE' },
        { t:'ضرب عدد من رقمين في عدد من رقمين', tag:'أعداد', ref:'MATH_P4_U6_MUL2X2' },
        { t:'ضرب عدد من ثلاثة أرقام في عدد من رقمين', tag:'أعداد', ref:'MATH_P4_U6_MUL3X2' }
      ]}
    ]},

    'p4.s1.sci':{ eyebrow:'علوم · الرابع الابتدائي', units:[
      { t:'ممالك المخلوقات الحيّة', s:'المخلوقات الحيّة · الفصل الأول', lessons:[
        { t:'الخلايا', tag:'أحياء', ref:'SCI_P4_U1_CELLS' },
        { t:'تصنيف المخلوقات الحيّة', tag:'تصنيف', ref:'SCI_P4_U1_CLASSIFY' }
      ]},
      { t:'المملكة الحيوانيّة', s:'المخلوقات الحيّة · الفصل الثاني', lessons:[
        { t:'الحيوانات اللافقاريّة', tag:'أحياء', ref:'SCI_P4_U2_INVERT' },
        { t:'الحيوانات الفقاريّة', tag:'أحياء', ref:'SCI_P4_U2_VERT' },
        { t:'أجهزة أجسام الحيوانات', tag:'أحياء', ref:'SCI_P4_U2_SYSTEMS' }
      ]},
      { t:'استكشاف الأنظمة البيئيّة', s:'الأنظمة البيئيّة · الفصل الثالث', lessons:[
        { t:'مقدّمة في الأنظمة البيئيّة', tag:'بيئة', ref:'SCI_P4_U3_INTRO' },
        { t:'العلاقات في الأنظمة البيئيّة', tag:'بيئة', ref:'SCI_P4_U3_RELATIONS' },
        { t:'التغيّرات في الأنظمة البيئيّة', tag:'بيئة', ref:'SCI_P4_U3_CHANGES' }
      ]},
      { t:'الأمراض والعدوى', s:'صحّة الإنسان · الفصل الرابع', lessons:[
        { t:'الأمراض', tag:'صحّة', ref:'SCI_P4_U4_DISEASE' },
        { t:'العدوى وانتقالها', tag:'صحّة', ref:'SCI_P4_U4_INFECTION' }
      ]},
      { t:'التغذية والصحّة', s:'صحّة الإنسان · الفصل الخامس', lessons:[
        { t:'المحافظة على الصحّة', tag:'صحّة', ref:'SCI_P4_U5_HEALTH' },
        { t:'الغذاء والتغذية', tag:'صحّة', ref:'SCI_P4_U5_NUTRITION' }
      ]}
    ]},
    ...
    'p5.s1.math':{ eyebrow:'رياضيات · الخامس الابتدائي', units:[
      { t:'القيمة المنزلية والكسور العشرية', s:'الفصل الأول', lessons:[
        { t:'القيمة المنزلية', tag:'أعداد', ref:'MATH_P5_U1_PLACE' },
        { t:'المقارنة بين الأعداد', tag:'أعداد', ref:'MATH_P5_U1_COMPARE' },
        { t:'تمثيل الكسور العشرية', tag:'أعداد', ref:'MATH_P5_U1_DECIMALS' },
        { t:'القيمة المنزلية ضمن أجزاء الألف', tag:'أعداد', ref:'MATH_P5_U1_THOUSANDTHS' },
        { t:'مقارنة الكسور العشرية', tag:'أعداد', ref:'MATH_P5_U1_DCOMPARE' },
        { t:'ترتيب الأعداد والكسور العشرية', tag:'أعداد', ref:'MATH_P5_U1_ORDER' }
      ]},
      { t:'الجمع والطرح', s:'الفصل الثاني', lessons:[
        { t:'تقريب الأعداد والكسور العشرية', tag:'أعداد', ref:'MATH_P5_U2_ROUND' },
        { t:'تقدير نواتج الجمع والطرح', tag:'مهارة', ref:'MATH_P5_U2_ESTIMATE' },
        { t:'جمع الكسور العشرية وطرحها', tag:'أعداد', ref:'MATH_P5_U2_ADDSUB' },
        { t:'خصائص الجمع', tag:'جبر', ref:'MATH_P5_U2_PROPS' },
        { t:'الجمع والطرح ذهنيًّا', tag:'مهارة', ref:'MATH_P5_U2_MENTAL' }
      ]},
      { t:'الضرب', s:'الفصل الثالث', lessons:[
        { t:'أنماط الضرب', tag:'أعداد', ref:'MATH_P5_U3_PATTERNS' },
        { t:'خاصية التوزيع', tag:'جبر', ref:'MATH_P5_U3_DISTRIB' },
        { t:'تقدير نواتج الضرب', tag:'مهارة', ref:'MATH_P5_U3_ESTMUL' },
        { t:'الضرب في عدد من رقم واحد', tag:'أعداد', ref:'MATH_P5_U3_MUL1' },
        { t:'الضرب في عدد من رقمين', tag:'أعداد', ref:'MATH_P5_U3_MUL2' }
      ]},
      { t:'القسمة', s:'الفصل الرابع', lessons:[
        { t:'أنماط القسمة', tag:'أعداد', ref:'MATH_P5_U4_PATTERNS' },
        { t:'تقدير نواتج القسمة', tag:'مهارة', ref:'MATH_P5_U4_ESTIMATE' },
        { t:'القسمة على عدد من رقم واحد', tag:'أعداد', ref:'MATH_P5_U4_DIV1' },
        { t:'القسمة على عدد من رقمين', tag:'أعداد', ref:'MATH_P5_U4_DIV2' },
        { t:'تفسير باقي القسمة', tag:'مهارة', ref:'MATH_P5_U4_REMAINDER' }
      ]},
      { t:'الجبر: العبارات والدوال والمعادلات', s:'الفصل الخامس', lessons:[
        { t:'عبارات الجمع والطرح الجبرية', tag:'جبر', ref:'MATH_P5_U5_EXPR' },
        { t:'عبارات الضرب والقسمة الجبرية', tag:'جبر', ref:'MATH_P5_U5_EXPRMD' },
        { t:'جداول الدوال', tag:'جبر', ref:'MATH_P5_U5_FUNC' },
        { t:'ترتيب العمليات', tag:'جبر', ref:'MATH_P5_U5_ORDER' },
        { t:'معادلات الجمع والطرح', tag:'جبر', ref:'MATH_P5_U5_EQAS' }
      ]},
      { t:'الكسور الاعتيادية', s:'الفصل السادس', lessons:[
        { t:'القسمة والكسور الاعتيادية', tag:'كسور', ref:'MATH_P5_U6_DIVFRAC' },
        { t:'الكسور غير الفعلية', tag:'كسور', ref:'MATH_P5_U6_IMPROPER' },
        { t:'الأعداد الكسرية', tag:'كسور', ref:'MATH_P5_U6_MIXED' },
        { t:'مقارنة الكسور والأعداد الكسرية', tag:'كسور', ref:'MATH_P5_U6_COMPARE' },
        { t:'تقريب الكسور', tag:'كسور', ref:'MATH_P5_U6_ROUND' }
      ]}
    ]},

    'p5.s1.sci':{ eyebrow:'علوم · الخامس الابتدائي', units:[
      { t:'ممالك المخلوقات الحيّة', s:'تنوّع الحياة · الفصل الأول', lessons:[
        { t:'تصنيف المخلوقات الحيّة', tag:'تصنيف', ref:'SCI_P5_U1_CLASSIFY' },
        { t:'النباتات', tag:'نبات', ref:'SCI_P5_U1_PLANTS' }
      ]},
      { t:'الآباء والأبناء', s:'تنوّع الحياة · الفصل الثاني', lessons:[
        { t:'التكاثر', tag:'أحياء', ref:'SCI_P5_U2_REPRO' },
        { t:'دورات الحياة', tag:'أحياء', ref:'SCI_P5_U2_LIFECYCLE' }
      ]},
      { t:'التفاعلات في الأنظمة البيئية', s:'الأنظمة البيئية · الفصل الثالث', lessons:[
        { t:'العلاقات في الأنظمة البيئية', tag:'بيئة', ref:'SCI_P5_U3_RELATIONS' },
        { t:'التكيّف والبقاء', tag:'بيئة', ref:'SCI_P5_U3_ADAPT' }
      ]},
      { t:'الدورات والتغيّرات في الأنظمة البيئية', s:'الأنظمة البيئية · الفصل الرابع', lessons:[
        { t:'الدورات في الأنظمة البيئية', tag:'بيئة', ref:'SCI_P5_U4_CYCLES' },
        { t:'التغيّرات في الأنظمة البيئية', tag:'بيئة', ref:'SCI_P5_U4_CHANGES' }
      ]},
      { t:'أرضُنا المتغيّرة', s:'الأرض ومواردها · الفصل الخامس', lessons:[
        { t:'معالم سطح الأرض', tag:'أرض', ref:'SCI_P5_U5_LANDFORMS' },
        { t:'العمليات المؤثّرة في سطح الأرض', tag:'أرض', ref:'SCI_P5_U5_PROCESSES' }
      ]},
      { t:'حماية موارد الأرض', s:'الأرض ومواردها · الفصل السادس', lessons:[
        { t:'مصادر الطاقة', tag:'موارد', ref:'SCI_P5_U6_ENERGY' },
        { t:'الهواء والماء', tag:'موارد', ref:'SCI_P5_U6_AIRWATER' }
      ]}
    ]},

    'p5.s1.ar':{ eyebrow:'لغتي · الخامس الابتدائي', units:[
      { t:'الصنف اللغوي', s:'أخلاق وفضائل · الجموع والأفعال', lessons:[
        { t:'أنواع الجموع', tag:'صنف لغوي', ref:'AR_LUGHATI_P5_U1_JUMOU' },
        { t:'جمع المذكّر السالم', tag:'صنف لغوي', ref:'AR_LUGHATI_P5_U1_MUDHAKKAR' },
        { t:'الأفعال الخمسة', tag:'صنف لغوي', ref:'AR_LUGHATI_P5_U1_AFAAL5' }
      ]},
      { t:'الظاهرة الإملائية', s:'أخلاق وفضائل · الهمزة المتوسطة', lessons:[
        { t:'الهمزة المتوسطة على الألف', tag:'إملاء', ref:'AR_LUGHATI_P5_U1_HAMZAALIF' },
        { t:'الهمزة المتوسطة على الواو', tag:'إملاء', ref:'AR_LUGHATI_P5_U1_HAMZAWAW' }
      ]},
      { t:'الوظيفة النحوية', s:'أخلاق وفضائل · الرفع بالعلامات الفرعية', lessons:[
        { t:'رفع المبتدأ والخبر بالعلامات الفرعية', tag:'نحو', ref:'AR_LUGHATI_P5_U1_RAFAMUB' },
        { t:'رفع الفاعل بالعلامات الفرعية', tag:'نحو', ref:'AR_LUGHATI_P5_U1_RAFAFAIL' }
      ]}
    ]},
    ...
    'p6.s1.math':{ eyebrow:'رياضيات · السادس الابتدائي', units:[
      { t:'الجبر: الأنماط والدوال', s:'الفصل الأول', lessons:[
        { t:'استراتيجية: الخطوات الأربع لحل المسألة', tag:'مهارة', ref:'MATH_P6_U1_STEPS' },
        { t:'العوامل الأولية', tag:'أعداد', ref:'MATH_P6_U1_FACTORS' },
        { t:'القوى والأسس', tag:'أعداد', ref:'MATH_P6_U1_POWERS' },
        { t:'ترتيب العمليات', tag:'عمليات', ref:'MATH_P6_U1_ORDER' },
        { t:'المتغيرات والعبارات الجبرية', tag:'جبر', ref:'MATH_P6_U1_VARS' },
        { t:'الدوال', tag:'جبر', ref:'MATH_P6_U1_FUNC' },
        { t:'استراتيجية: التخمين والتحقّق', tag:'مهارة', ref:'MATH_P6_U1_GUESS' },
        { t:'المعادلات', tag:'جبر', ref:'MATH_P6_U1_EQ' }
      ]},
      { t:'الإحصاء والتمثيلات البيانية', s:'الفصل الثاني', lessons:[
        { t:'استراتيجية: إنشاء جدول', tag:'مهارة', ref:'MATH_P6_U2_TABLE' },
        { t:'التمثيل بالأعمدة وبالخطوط', tag:'بيانات', ref:'MATH_P6_U2_BARS' },
        { t:'التمثيل بالنقاط', tag:'بيانات', ref:'MATH_P6_U2_DOTS' },
        { t:'المتوسط الحسابي', tag:'بيانات', ref:'MATH_P6_U2_MEAN' },
        { t:'الوسيط والمنوال والمدى', tag:'بيانات', ref:'MATH_P6_U2_MEDIAN' }
      ]},
      { t:'الكسور العشرية', s:'الفصل الثالث', lessons:[
        { t:'تمثيل الكسور العشرية', tag:'كسور', ref:'MATH_P6_U3_REP' },
        { t:'مقارنة الكسور العشرية وترتيبها', tag:'كسور', ref:'MATH_P6_U3_COMPARE' },
        { t:'تقريب الكسور العشرية', tag:'كسور', ref:'MATH_P6_U3_ROUND' },
        { t:'تقدير ناتج الجمع والطرح', tag:'مهارة', ref:'MATH_P6_U3_ESTIMATE' },
        { t:'جمع الكسور العشرية وطرحها', tag:'عمليات', ref:'MATH_P6_U3_ADDSUB' },
        { t:'ضرب الكسور العشرية في أعداد كلية', tag:'عمليات', ref:'MATH_P6_U3_MULWHOLE' },
        { t:'ضرب الكسور العشرية', tag:'عمليات', ref:'MATH_P6_U3_MUL' },
        { t:'قسمة الكسور العشرية على أعداد كلية', tag:'عمليات', ref:'MATH_P6_U3_DIVWHOLE' },
        { t:'القسمة على كسر عشري', tag:'عمليات', ref:'MATH_P6_U3_DIVDEC' },
        { t:'استراتيجية: التحقق من معقولية الإجابة', tag:'مهارة', ref:'MATH_P6_U3_REASON' }
      ]},
      { t:'الكسور الاعتيادية والعشرية', s:'الفصل الرابع', lessons:[
        { t:'القاسم المشترك الأكبر', tag:'أعداد', ref:'MATH_P6_U4_GCF' },
        { t:'تبسيط الكسور الاعتيادية', tag:'كسور', ref:'MATH_P6_U4_SIMPLIFY' },
        { t:'الأعداد الكسرية والكسور غير الفعلية', tag:'كسور', ref:'MATH_P6_U4_MIXED' },
        { t:'المضاعف المشترك الأصغر', tag:'أعداد', ref:'MATH_P6_U4_LCM' },
        { t:'مقارنة الكسور الاعتيادية وترتيبها', tag:'كسور', ref:'MATH_P6_U4_FCOMPARE' },
        { t:'كتابة الكسور العشرية في صورة اعتيادية', tag:'كسور', ref:'MATH_P6_U4_DEC2FRAC' },
        { t:'كتابة الكسور الاعتيادية في صورة عشرية', tag:'كسور', ref:'MATH_P6_U4_FRAC2DEC' },
        { t:'استراتيجية: إنشاء قائمة منظمة', tag:'مهارة', ref:'MATH_P6_U4_LIST' }
      ]},
      { t:'القياس: الطول والكتلة والسعة', s:'الفصل الخامس', lessons:[
        { t:'الطول في النظام المتري', tag:'قياس', ref:'MATH_P6_U5_LENGTH' },
        { t:'الكتلة والسعة في النظام المتري', tag:'قياس', ref:'MATH_P6_U5_MASS' },
        { t:'استراتيجية: استعمال مقياس مرجعي', tag:'مهارة', ref:'MATH_P6_U5_BENCH' },
        { t:'التحويل بين الوحدات المترية', tag:'قياس', ref:'MATH_P6_U5_CONVERT' }
      ]}
    ]},

    'p6.s1.sci':{ eyebrow:'علوم · السادس الابتدائي', units:[
      { t:'الخلايا', s:'تنوّع الحياة · الفصل الأول', lessons:[
        { t:'نظرية الخلية', tag:'خلايا', ref:'SCI_P6_U1_CELLTHEORY' },
        { t:'الخلية النباتية والخلية الحيوانية', tag:'خلايا', ref:'SCI_P6_U1_CELLTYPES' }
      ]},
      { t:'الخلية والوراثة', s:'تنوّع الحياة · الفصل الثاني', lessons:[
        { t:'انقسام الخلايا', tag:'خلايا', ref:'SCI_P6_U2_DIVISION' },
        { t:'الوراثة والصفات', tag:'وراثة', ref:'SCI_P6_U2_HEREDITY' }
      ]},
      { t:'عمليات الحياة في النباتات والمخلوقات الدقيقة', s:'عمليات الحياة · الفصل الثالث', lessons:[
        { t:'عمليات الحياة في النباتات', tag:'نبات', ref:'SCI_P6_U3_PLANTLIFE' },
        { t:'عمليات الحياة في المخلوقات الحية الدقيقة', tag:'أحياء دقيقة', ref:'SCI_P6_U3_MICROLIFE' }
      ]},
      { t:'عمليات الحياة في الإنسان والحيوانات', s:'عمليات الحياة · الفصل الرابع', lessons:[
        { t:'الهضم والإخراج والتنفس والدوران', tag:'أجهزة الجسم', ref:'SCI_P6_U4_SYSTEMS' },
        { t:'الحركة والإحساس', tag:'أجهزة الجسم', ref:'SCI_P6_U4_MOVESENSE' }
      ]},
      { t:'الأنظمة البيئية', s:'الأنظمة البيئية ومواردها · الفصل الخامس', lessons:[
        { t:'السلاسل والشبكات الغذائية وهرم الطاقة', tag:'بيئة', ref:'SCI_P6_U5_FOODCHAIN' },
        { t:'مقارنة الأنظمة البيئية', tag:'بيئة', ref:'SCI_P6_U5_ECOSYSTEMS' }
      ]},
      { t:'موارد الأرض والحفاظ عليها', s:'الأنظمة البيئية ومواردها · الفصل السادس', lessons:[
        { t:'التربة', tag:'أرض', ref:'SCI_P6_U6_SOIL' },
        { t:'حماية الموارد', tag:'موارد', ref:'SCI_P6_U6_RESOURCES' }
      ]}
    ]},
    ...
    'g1.s2.sci':{ eyebrow:'علوم · الأول متوسط', units:[
      { t:'الغلاف الجوي المتحرك', s:'الوحدة الرابعة · الفصل السابع', lessons:[
        { t:'الغلاف الجوي والطقس', tag:'مفاهيم', ref:'SCI_G1_U7_ATMOS' },
        { t:'الكتل والجبهات الهوائية', tag:'مفاهيم', ref:'SCI_G1_U7_FRONTS' }
      ]},
      { t:'استكشاف الفضاء', s:'الوحدة الرابعة · الفصل الثامن', lessons:[
        { t:'الأرض والنظام الشمسي', tag:'مفاهيم', ref:'SCI_G1_U8_SOLAR' },
        { t:'الفضاء والنجوم والمجرات', tag:'مفاهيم', ref:'SCI_G1_U8_STARS' }
      ]},
      { t:'الخلايا لبنات الحياة', s:'الوحدة الخامسة · الفصل التاسع', lessons:[
        { t:'عالم الخلايا', tag:'مفاهيم', ref:'SCI_G1_U9_CELLS' },
        { t:'وظائف الخلايا', tag:'مفاهيم', ref:'SCI_G1_U9_CELLFUNC' }
      ]},
      { t:'الحيوانات اللافقارية', s:'الوحدة الخامسة · الفصل العاشر', lessons:[
        { t:'الإسفنجيات واللاسعات والديدان', tag:'مفاهيم', ref:'SCI_G1_U10_INVERT1' },
        { t:'الرخويات والمفصليات وشوكيات الجلد', tag:'مفاهيم', ref:'SCI_G1_U10_INVERT2' }
      ]},
      { t:'الحيوانات الفقارية', s:'الوحدة الخامسة · الفصل الحادي عشر', lessons:[
        { t:'الحبليات ومجموعاتها', tag:'مفاهيم', ref:'SCI_G1_U11_CHORDATES' },
        { t:'الطيور والثدييات', tag:'مفاهيم', ref:'SCI_G1_U11_BIRDMAM' }
      ]},
      { t:'علم البيئة', s:'الوحدة السادسة · الفصل الثاني عشر', lessons:[
        { t:'ما النظام البيئي؟', tag:'مفاهيم', ref:'SCI_G1_U12_ECO' },
        { t:'المخلوقات الحية والبيئة والطاقة', tag:'مفاهيم', ref:'SCI_G1_U12_ENERGY' }
      ]}
    ]},
    ...
    'g3.s2.math':{ eyebrow:'رياضيات · الثالث متوسط', units:[
      { t:'كثيرات الحدود', s:'الفصل السادس', lessons:[
        { t:'ضرب وحيدات الحد', tag:'جبر', ref:'MATH_G3_U6_MULMONO' },
        { t:'قسمة وحيدات الحد', tag:'جبر', ref:'MATH_G3_U6_DIVMONO' },
        { t:'كثيرات الحدود', tag:'جبر', ref:'MATH_G3_U6_POLY' },
        { t:'جمع كثيرات الحدود وطرحها', tag:'جبر', ref:'MATH_G3_U6_ADDPOLY' },
        { t:'ضرب وحيدة الحد في كثيرة الحدود', tag:'جبر', ref:'MATH_G3_U6_MULMP' },
        { t:'ضرب كثيرات الحدود', tag:'جبر', ref:'MATH_G3_U6_MULPOLY' },
        { t:'حالات خاصة من الضرب', tag:'جبر', ref:'MATH_G3_U6_SPECIAL' }
      ]},
      { t:'التحليل والمعادلات التربيعية', s:'الفصل السابع', lessons:[
        { t:'تحليل وحيدات الحد', tag:'جبر', ref:'MATH_G3_U7_FACTMONO' },
        { t:'التحليل باستعمال خاصية التوزيع', tag:'جبر', ref:'MATH_G3_U7_DISTRIB' },
        { t:'حل المعادلات التربيعية: س² + بس + جـ', tag:'جبر', ref:'MATH_G3_U7_QUADBC' },
        { t:'حل المعادلات التربيعية: أس² + بس + جـ', tag:'جبر', ref:'MATH_G3_U7_QUADABC' },
        { t:'الفرق بين مربّعين', tag:'جبر', ref:'MATH_G3_U7_DIFFSQ' },
        { t:'المربّعات الكاملة', tag:'جبر', ref:'MATH_G3_U7_PERFSQ' }
      ]},
      { t:'الدوال والمعادلات التربيعية', s:'الفصل الثامن', lessons:[
        { t:'تمثيل الدوال التربيعية بيانيًّا', tag:'دوال', ref:'MATH_G3_U8_GRAPH' },
        { t:'حل المعادلات التربيعية بيانيًّا', tag:'دوال', ref:'MATH_G3_U8_SOLVEGRAPH' },
        { t:'حل المعادلات التربيعية بإكمال المربّع', tag:'جبر', ref:'MATH_G3_U8_COMPLETE' },
        { t:'حل المعادلات التربيعية بالقانون العام', tag:'جبر', ref:'MATH_G3_U8_FORMULA' }
      ]},
      { t:'الجذور ونظرية فيثاغورس', s:'الفصل التاسع', lessons:[
        { t:'تبسيط العبارات الجذرية', tag:'جبر', ref:'MATH_G3_U9_SIMPRAD' },
        { t:'العمليات على العبارات الجذرية', tag:'جبر', ref:'MATH_G3_U9_OPSRAD' },
        { t:'المعادلات الجذرية', tag:'جبر', ref:'MATH_G3_U9_RADEQ' },
        { t:'نظرية فيثاغورس', tag:'هندسة', ref:'MATH_G3_U9_PYTHAG' },
        { t:'المسافة بين نقطتين', tag:'هندسة', ref:'MATH_G3_U9_DISTANCE' },
        { t:'المثلثات المتشابهة', tag:'تشابه', ref:'MATH_G3_U9_SIMILAR' },
        { t:'النسب المثلثية', tag:'هندسة', ref:'MATH_G3_U9_TRIG' }
      ]},
      { t:'الإحصاء والاحتمال', s:'الفصل العاشر', lessons:[
        { t:'تصميم دراسة مسحية', tag:'إحصاء', ref:'MATH_G3_U10_SURVEY' },
        { t:'تحليل نتائج الدراسة المسحية', tag:'إحصاء', ref:'MATH_G3_U10_ANALYZE' },
        { t:'إحصاءات العيّنة ومعالم المجتمع', tag:'إحصاء', ref:'MATH_G3_U10_SAMPLE' },
        { t:'التباديل والتوافيق', tag:'احتمال', ref:'MATH_G3_U10_PERMCOMB' },
        { t:'احتمالات الحوادث المركّبة', tag:'احتمال', ref:'MATH_G3_U10_COMPOUND' }
      ]}
    ]},
    ...
    'g3.s2.sci':{ eyebrow:'علوم · الثالث متوسط', units:[
      { t:'البناء الذري والروابط الكيميائية', s:'الوحدة الرابعة · الفصل السابع', lessons:[
        { t:'اتحاد الذرات', tag:'مفاهيم', ref:'SCI_G3S2_U7_ATOMS' },
        { t:'روابط العناصر', tag:'مفاهيم', ref:'SCI_G3S2_U7_BONDS' }
      ]},
      { t:'التفاعلات الكيميائية', s:'الوحدة الرابعة · الفصل الثامن', lessons:[
        { t:'الصيغ والمعادلات الكيميائية', tag:'مفاهيم', ref:'SCI_G3S2_U8_EQ' },
        { t:'سرعة التفاعلات الكيميائية', tag:'مفاهيم', ref:'SCI_G3S2_U8_RATES' }
      ]},
      { t:'الحركة والزخم', s:'الوحدة الخامسة · الفصل التاسع', lessons:[
        { t:'الحركة', tag:'مفاهيم', ref:'SCI_G3S2_U9_MOTION' },
        { t:'التسارع', tag:'مفاهيم', ref:'SCI_G3S2_U9_ACCEL' },
        { t:'الزخم والتصادمات', tag:'مفاهيم', ref:'SCI_G3S2_U9_MOMENTUM' }
      ]},
      { t:'القوة وقوانين نيوتن', s:'الوحدة الخامسة · الفصل العاشر', lessons:[
        { t:'القانونان الأول والثاني لنيوتن', tag:'مفاهيم', ref:'SCI_G3S2_U10_NEWTON12' },
        { t:'القانون الثالث لنيوتن', tag:'مفاهيم', ref:'SCI_G3S2_U10_NEWTON3' }
      ]},
      { t:'الكهرباء', s:'الوحدة السادسة · الفصل الحادي عشر', lessons:[
        { t:'التيار الكهربائي', tag:'مفاهيم', ref:'SCI_G3S2_U11_CURRENT' },
        { t:'الدوائر الكهربائية وقانون أوم', tag:'مفاهيم', ref:'SCI_G3S2_U11_CIRCUITS' }
      ]},
      { t:'المغناطيسية', s:'الوحدة السادسة · الفصل الثاني عشر', lessons:[
        { t:'الخصائص العامة للمغناطيس', tag:'مفاهيم', ref:'SCI_G3S2_U12_MAGNETS' },
        { t:'الكهرومغناطيسية', tag:'مفاهيم', ref:'SCI_G3S2_U12_ELECTROMAG' }
      ]}
    ]},
    ...
    'g2.s2.sci':{ eyebrow:'علوم · الثاني متوسط', units:[
      { t:'أجهزة الدعامة والحركة والاستجابة', s:'الوحدة ٤ · أجهزة جسم الإنسان-٢', lessons:[
        { t:'الجلد والعضلات', tag:'أحياء', ref:'SCI_G2_U7_SKIN' },
        { t:'الجهاز الهيكلي والجهاز العصبي', tag:'أحياء', ref:'SCI_G2_U7_SKELETON' }
      ]},
      { t:'التنظيم والتكاثر', s:'الوحدة ٤ · أجهزة جسم الإنسان-٢', lessons:[
        { t:'جهاز الغدد الصم والتكاثر', tag:'أحياء', ref:'SCI_G2_U8_GLANDS' },
        { t:'مراحل حياة الإنسان', tag:'أحياء', ref:'SCI_G2_U8_LIFE' }
      ]},
      { t:'النباتات', s:'الوحدة ٥ · النباتات وموارد البيئة', lessons:[
        { t:'النباتات اللابذرية', tag:'أحياء', ref:'SCI_G2_U9_SEEDLESS' },
        { t:'النباتات البذرية', tag:'أحياء', ref:'SCI_G2_U9_SEED' }
      ]},
      { t:'موارد البيئة وحمايتها', s:'الوحدة ٥ · النباتات وموارد البيئة', lessons:[
        { t:'موارد البيئة', tag:'مفاهيم', ref:'SCI_G2_U10_RESOURCES' },
        { t:'التلوث وحماية البيئة', tag:'مفاهيم', ref:'SCI_G2_U10_POLLUTION' }
      ]},
      { t:'الطاقة الحرارية', s:'الوحدة ٦ · الطاقة الحرارية والموجات', lessons:[
        { t:'درجة الحرارة', tag:'مفاهيم', ref:'SCI_G2_U11_TEMP' },
        { t:'انتقال الحرارة', tag:'مفاهيم', ref:'SCI_G2_U11_TRANSFER' },
        { t:'المحركات والثلاجات', tag:'مفاهيم', ref:'SCI_G2_U11_ENGINES' }
      ]},
      { t:'الموجات والصوت والضوء', s:'الوحدة ٦ · الطاقة الحرارية والموجات', lessons:[
        { t:'الموجات', tag:'مفاهيم', ref:'SCI_G2_U12_WAVES' },
        { t:'موجات الصوت', tag:'مفاهيم', ref:'SCI_G2_U12_SOUND' },
        { t:'الضوء', tag:'مفاهيم', ref:'SCI_G2_U12_LIGHT' }
      ]}
    ]},
