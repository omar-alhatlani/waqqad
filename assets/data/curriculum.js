...
window.CURRICULUM = {
  ...
  content:{
    ...
    'g1.s1.ar':{ eyebrow:'لغتي · الأول متوسط', units:[
      { t:'القيم الإسلامية', s:'وحدة القراءة والنصوص', lessons:[
        { t:'الظاهرة الإملائية — التنوين', tag:'إملاء', ref:null },
        { t:'الصنف اللغوي — الاسم والفعل', tag:'نحو', ref:null },
        { t:'النص القرائي — برّ الوالدين', tag:'قراءة', ref:null }
      ]},
      { t:'الصحة والغذاء', s:'وحدة العلم والحياة', lessons:[] },
      { t:'العلم والإيمان', s:'النصوص والتحليل الأدبي', lessons:[] }
    ]},
